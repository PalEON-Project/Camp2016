...
$$
$$
\beta_t \sim \mathcal{N}(0, \phi_t)
$$
$$
\beta_0 \sim \mathcal{N}(0, 10000)  
$$

1. Interpret the meaning of the various parameters in the model. How do they account for inter-individual variability and year-to-year variability? What is the meaning of $\tau^2$, $\sigma^2$, and $\phi_t$. How about $w$ and $v$?

2. What priors do we need to complete the model?

3. If we set $\phi_t$ to some (large) fixed value, how does the interpretation of the model change, compared to having a prior distribution on $\phi_t$ and estimating $\phi_t$?
