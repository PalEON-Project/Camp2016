...
1. Interpret the meaning of the various parameters in the model. How do they account for inter-individual variability and year-to-year variability? What is the meaning of $\tau^2$, $\sigma^2$, and $\phi_t^2$. How about $w^2$ and $v^2$?

2. What priors do we need to complete the model?

3. If we set $\phi_t^2$ to some (large) fixed value, how does the interpretation of the model change, compared to having a prior distribution on $\phi_t^2$ and estimating $\phi_t^2$?
