...
5. Implement the model for the data in *rings.csv* in JAGS. Remember that JAGS uses the precision (inverse variance) as the second parameter of the normal distribution.  I'd suggest using flat priors on the standard deviation for the variance terms in the model.
