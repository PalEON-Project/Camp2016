...
```{r reading files}
getwd()
setwd('~/Desktop/Camp2014/statsR')

pollen <- read.csv('data/newEngland/modernPollen.csv', header = TRUE)
...
title(main = paste('Pollen composition of ', nrow(full), ' ponds in New England', sep = ''), outer = TRUE, line = 1, cex.main = 1.5)
dev.off()
#help(par)
par()$mfrow
```
